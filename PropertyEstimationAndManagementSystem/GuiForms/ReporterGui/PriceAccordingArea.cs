...
namespace PropertyEstimationAndManagementSystem.GuiForms.Consultant
{
    public partial class PriceAccordingArea : Form
    {
        ...
        private void PriceAccordingArea_Load(object sender, EventArgs e)
        {
            ...
            this.dataGridArea.DefaultCellStyle.ForeColor = Color.WhiteSmoke;
            this.dataGridArea.DefaultCellStyle.BackColor = Color.FromArgb(36,36,36);
        ...
        public void setChart()
        {
            ...
            chartArea.Titles.Add("Color Grade From Highest Price to Lowest Price");
